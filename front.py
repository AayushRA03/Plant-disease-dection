...
def model_predict(image_path):
    model = tf.keras.models.load_model(r"C:/Users/Aayush Rathore/Desktop/project/Plant disease dection/CNN_plantdiseases_model.keras")
...
# Prediction Page
    ...
    if(st.button("Predict")):
        ...
        search_query = predicted_disease.replace("___", " ").replace("_", " ")
        google_link = f"https://www.google.com/search?q={search_query.replace(' ', '+')}"
        st.markdown(f"[Click here]( {google_link} ) to know more about **{predicted_disease}** on Google.", unsafe_allow_html=True)
